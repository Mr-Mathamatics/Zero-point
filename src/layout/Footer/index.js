                    ...
                    <div className="py-10 text-center md:text-left">
                        <div className="grid grid md:grid-cols-10 gap-4">
                            ...
                            <div className='col-span-2'>
                                ...
                                <p className="mb-3">
                                    <Link to="my-courses" className='footer_link'>My Courses</Link>
                                </p>
                                <p className="mb-3">
                                    <Link to="marketplace" className='footer_link'>Marketplace</Link>
                                </p>
                                <p className="mb-3">
                                    <Link to="about-us" className='footer_link'>About Us</Link>
                                </p>
                                <p>
                                    <Link to="contact-us" className='footer_link'>Contact Us</Link>
                                </p>
                            </div>
                            <div className='col-span-2'>
                                <h5 className="">
                                ...
                                <p className="mb-3">
                                    <Link to="#!" className='footer_link'>Return Policy</Link>
                                </p>
                            </div>
                            ...
                            <div className='col-span-3'>
                                ...
                                <div className='footer-social'>
                                    ...
                                    <a href="linkedin.com" className="social-link">
